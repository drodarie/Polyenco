...
var path = document.getElementById("webroot").value;
...
BRUSHED.contactForm = function(){
	$("#contact-submit").on('click',function() {
		...
		$.ajax({
			type: "POST",
			url: path+"/webroot/Librairies/brushed/_include/php/contact.php",
			data: fields,
			dataType: 'json',
...
BRUSHED.tweetFeed = function(){
    ...
    $("#ticker").tweet({
          modpath: path+'/webroot/Librairies/brushed/_include/js/twitter/',
