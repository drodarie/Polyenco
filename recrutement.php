    ...
    <body>
        ...
        <header>
            <div class="sticky-nav">
                ...
                <nav id="menu">
                    <ul id="menu-nav">
                        <li class="current"><a href="#Accueil" id="menu1">Accueil</a></li>
        ...
        <div id="Presentation" class="page">
            <div class="container">
                <div class="row">
                    <h1 class="title-page">Qui sommes-nous?</h1>
                </div>
                ...
                <div id="bloc" class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <ul  class="big-list-style-none small-list-margin">
                            ...
                            <li>Polyenco est donc une association qui profite à ses membres à travers l'apprentissage de nombreuses compétences telles que l'administration d'une structure, la négociation avec les clients, la trésorerie, la communication, ...</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <!-- Section Recrutement -->
        <div id="Recrutement" class="page">
            <div class="container">
                <div class="row">
                    <h1 class="title-page">Recrutement</h1>
                </div>

                <div id="bloc" class="row">
                    <div class="col-xs-12 col-sm-12 col-md-8">
                        <ul  class="big-list-style-none small-list-margin">
                            <li>Le recrutement pour le premier semestre de l'année 2015-016 est ouvert dès à présent.</li>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4">
                        <img src="img/Recrutement/Recrutement.jpg" class="img-responsive" alt="Recrutement" style="padding: 10px">
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- Section Tombola -->
        <div id="Tombola" class="page">
            <div class="container">
                <div class="row">
                    <h1 class="title-page">Tombola</h1>
                </div>

                <div id="bloc" class="row">
                    <div class="col-xs-12 col-sm-12 col-md-4">
                        <img src="img/Recrutement/Tombola.jpg" class="img-responsive" alt="Tombola" style="padding: 10px">
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-8">
                        <ul  class="big-list-style-none small-list-margin">
        ...
        <script src="js/initRecrutement.js"></script> <!-- Init recrutement page -->
        <!-- endbuild -->
